...
Note: The Itho Ventilation Unit requires the WiFi Add-On Module to be installed, which can be purchased from NRG Watch.
...
Requirements
	...
	•	Itho Ventilation Unit with the WiFi Add-On Module. You can purchase the module from NRG Watch.
